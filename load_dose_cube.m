function [cube, xVec, yVec, zVec, dicom_info] = load_dose_cube(dose_str)
...
% License: MIT
%
dicom_info = dicominfo(dose_str, 'UseVRHeuristic', false, 'UseDictionaryVR', true);
cube_o = dicomread(dose_str);

if ndims(cube_o) == 4
%     [cube, ~] = load_Dose(dose_path);
